...
export default function Home() {
  return (
    ...
    >
      <div className="w-3/4 md:h-[90dvh] mt-24 md:mt-0 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-0">
        <div className="md:w-1/2 text-center md:text-start md:-mt-20">
